...
export const metadata: Metadata = {
  ...
  description: "Book your driving lessons with Drive 4 Pass. Choose from standard lessons, intensive courses, ADI training, or franchise opportunities.",
};
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-base sm:text-lg text-gray-600 max-w-3xl mx-auto">
                Take the first step toward confident and safe driving with our expert instructors and structured lessons designed for all skill levels.
              </p>
            </div>
