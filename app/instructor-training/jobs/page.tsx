...
const trainingBenefits = [
  {
    ...
    description:
      "Train at your own pace with flexible scheduling options that fit around your current commitments.",
  },
  {
    icon: BookOpen,
    title: "Comprehensive Curriculum",
    description:
      "Master all three ADI exam parts with expert guidance and proven training methodologies.",
  },
  {
    icon: Users,
    title: "Expert Mentorship",
    description:
      "Learn from seasoned instructors with years of real-world teaching experience in Liverpool.",
  },
  {
    icon: Award,
    title: "DVSA Approved",
    description:
      "Fully accredited training program meeting all DVSA standards and requirements.",
  },
];
...
const jobBenefits = [
  {
    ...
    description:
      "Earn £25,000-£40,000+ per year with unlimited growth potential as you build your client base across Liverpool.",
  },
  {
    icon: Clock,
    title: "Work-Life Balance",
    description:
      "Set your own hours and work schedule. Perfect for those seeking flexibility and autonomy.",
  },
  {
    icon: Users,
  ...
  },
  {
    ...
    description:
      "Ongoing administrative, marketing, and professional development support throughout your career.",
  },
  {
    icon: Briefcase,
    title: "Flexible Working Options",
    description:
      "Choose between franchise partnership, self-employment, or using our dual-control vehicles across Liverpool.",
  },
  {
    icon: Target,
    title: "Career Progression",
    description:
      "Opportunities to advance into senior roles, training positions, or expand your own driving school in Liverpool.",
  },
];
...
const careerPaths = [
  {
    ...
    features: [
      ...
      "Hands-on practical experience in Liverpool",
  ...
  },
  {
    ...
    features: [
      "Franchise partnership opportunities in Liverpool",
...
const whyZellDriving = [
  {
    title: "Established Liverpool Brand",
    description:
      "Leverage our trusted reputation and years of experience in Liverpool",
  },
  {
    title: "Proven Track Record",
    description: "95%+ first-time pass rate for our ADI trainees in Liverpool",
  },
  {
    title: "Modern Fleet",
    description:
      "Access to well-maintained, dual-control vehicles with latest safety features",
  },
  {
    title: "Marketing Support",
    description:
      "Professional website, online booking system, and Liverpool-focused advertising",
  },
  {
    title: "Liverpool Network",
    description:
      "Join a growing community of qualified instructors across Liverpool",
  },
  {
    title: "Continuous Training",
    description:
      "Regular CPD sessions, standards checks support, and skills updates",
  },
];
  ...
  return (
    <PageShell title={content.title} intro={content.intro}>
      <div className="min-h-screen bg-white">
            ...
            <div className="max-w-6xl mx-auto">
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                  ...
                  { label: "Liverpool", sublabel: "Based & Operating" },
                  { label: "DVSA", sublabel: "Approved Training" },
                ].map((stat, index) => (
                  <div
                    key={index}
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <h2 className="text-3xl sm:text-5xl font-black text-gray-900 mb-6">
                Ready to Make a Difference in Liverpool?
              </h2>
              ...
              <div className="grid lg:grid-cols-2 gap-8">
                {careerPaths.map((path, index) => (
                  ...
                  >
                    ...
                    <div className="mb-8">
                      <h3
                        className={`text-2xl sm:text-3xl font-black mb-2 ${path.highlight ? "text-white" : "text-gray-900"}`}
                      >
                        {path.title}
                      </h3>
                      <p
                    ...
                    <ul className="space-y-4 mb-8">
                      {path.features.map((feature, idx) => (
                        <li key={idx} className="flex items-start gap-3">
                          <Check
                            className={`w-6 h-6 flex-shrink-0 ${path.highlight ? "text-yellow-400" : "text-green-500"}`}
                          />
                          <span
                            className={`text-base ${path.highlight ? "text-white" : "text-gray-700"}`}
                          >
                            {feature}
                          </span>
                        </li>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                ...
                <p className="text-lg text-gray-300 max-w-3xl mx-auto">
                  Our comprehensive ADI training program will guide you from
                  complete beginner to fully qualified driving instructor in
                  Liverpool
                </p>
              </div>
        ...
        {/* Application Form — uses existing EnquiryForm, Instructor Application tab only */}
        <section
          id="apply"
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg text-gray-300 mb-10">
                Our Liverpool team is ready to answer your questions and guide
              ...
              <div className="grid sm:grid-cols-2 gap-6 mb-10">
                ...
                >
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-xl font-bold">+44 7585 726191</div>
                  </div>
                </a>
              </div>
